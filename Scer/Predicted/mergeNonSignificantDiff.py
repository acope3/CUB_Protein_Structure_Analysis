...
# groups = set(["Coil_coil","Coil_helix","Coil_sheet","Helix_coil","Helix_helix","Helix_sheet","Sheet_coil","Sheet_helix","Sheet_sheet"])
# #groups = set(["Helix","Sheet","Coil","Turn","Start_helix","Start_sheet","Start_coil","End_helix","End_sheet","End_coil"])
# # # #testCheckMerge()
...
# with open("combinations_1_merged_per_group.txt",'w') as out:
#     for i in files:
#        if len(i) > 1:
#            value = i.split("/")[1]
#            set_1 = set(splitSpan(value))
#            remaining = groups.difference(set_1)
#            remaining.add(value)
#            x = list(remaining)
#            print len(x)
#            out.write(" ".join(x))
...
# genes_used,new_folder = mergeNonSigGenomes(["Helix","Sheet"],base_dir="Secondary_structures_trans_experimental_sep_nterm/")
# createExpressionFiles("Secondary_structures_trans_experimental_sep_nterm/"+new_folder,genes_used)
# genes_used,new_folder = mergeNonSigGenomes(["Coil","Turn"],base_dir="Secondary_structures_trans_experimental_sep_nterm/")
# createExpressionFiles("Secondary_structures_trans_experimental_sep_nterm/"+new_folder,genes_used)

# genes_used,new_folder = mergeNonSigGenomes(["Start_sheet","End_sheet","Sheet"],base_dir="Secondary_structures_begin_end/")
# createExpressionFiles("Secondary_structures_begin_end/"+new_folder,genes_used)
#
# genes_used,new_folder = mergeNonSigGenomes(["Start_coil","End_coil","Coil"],base_dir="Secondary_structures_begin_end/")
# createExpressionFiles("Secondary_structures_begin_end/"+new_folder,genes_used)

genes_used,new_folder = mergeNonSigGenomes(["Ordered_Disordered","Nterminus"],base_dir="Ordered_disordered/")
createExpressionFiles("Ordered_disordered/"+new_folder,genes_used)


# genes_used,new_folder = mergeNonSigGenomes(["Turn","Coil"],base_dir="Secondary_structures_30_to_35_downstream_end/")
# createExpressionFiles("Secondary_structures_30_to_35_downstream_end/"+new_folder,genes_used)

# genes_used,new_folder = mergeNonSigGenomes(["Helix","Sheet"],base_dir="Secondary_structures_30_to_35_downstream_end/")
# createExpressionFiles("Secondary_structures_30_to_35_downstream_end/"+new_folder,genes_used)