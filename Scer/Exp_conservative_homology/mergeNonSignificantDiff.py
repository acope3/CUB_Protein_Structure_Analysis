...
# genes_used,new_folder = mergeNonSigGenomes(["Helix","Start_helix"],base_dir="Secondary_structures_pechmann")
...
genes_used,new_folder = mergeNonSigGenomes(["Coil","Turn"],base_dir="Secondary_structures")
createExpressionFiles("Secondary_structures/"+new_folder,genes_used)
