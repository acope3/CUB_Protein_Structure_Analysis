...
# genes_used,new_folder = mergeNonSigGenomes(["Helix","Sheet"],base_dir="Secondary_structures_pechmann")
...
genes_used,new_folder = mergeNonSigGenomes(["Start_helix","End_helix","Start_sheet","End_sheet"],base_dir="Secondary_structures_begin_end")
